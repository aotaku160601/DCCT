...
class NLLLoss(nn.Module):
    ...
    def __init__(self, truncation_t: float = 7.0, reduction: str = "mean") -> None:
        super().__init__()
    ...
    def log_prob(self, y_prime: torch.Tensor, params: MixtureParams) -> torch.Tensor:
        ...
        centered = target - params.mu                    # [B,K,C,H,W]
        ...
        log_prob = torch.where(target > self.truncation_t - 1e-3, log_one_minus_cdf_minus, log_prob)
